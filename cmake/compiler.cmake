...
if(CMAKE_CUDA_COMPILER_ID MATCHES "NVIDIA")
  ...
  target_compile_options( kumi_opts INTERFACE $<$<COMPILE_LANGUAGE:CUDA>:--Werror all-warnings> )
endif()

if(CMAKE_CXX_COMPILER_ID MATCHES "NVHPC")
  target_compile_options( kumi_opts INTERFACE $<$<COMPILE_LANGUAGE:CXX>:-Werror -Wall -Wshadow -Wextra -Wunused-variable> )
