...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  if(CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
    ...
    target_compile_options( kumi_docs INTERFACE -Werror -Wall -Wextra -Wunused-variable -Wdocumentation)
  endif()
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  target_compile_options( kumi_docs INTERFACE /W3 /EHsc /Zc:preprocessor)
else()
  target_compile_options( kumi_docs INTERFACE -Werror -Wall -Wextra -Wunused-variable)
endif()
