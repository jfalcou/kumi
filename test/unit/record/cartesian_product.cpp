...
TTS_CASE("Check result::cartesian_product<Record...> behavior")
{
  ...
  TTS_TYPE_IS ( (kumi::result::cartesian_product_t< kumi::record<int_f    ,float_f    ,double_f>
                                                  , kumi::record<int_ptr_f,float_ptr_f>
                                                  >)
              , (kumi::tuple< kumi::record<int_f    , int_ptr_f   > 
                            , kumi::record<float_f  , int_ptr_f   >  
                            , kumi::record<double_f , int_ptr_f   >
                            , kumi::record<int_f    , float_ptr_f >
                            , kumi::record<float_f  , float_ptr_f >
