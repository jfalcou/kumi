...
TTS_CASE("Check record::split behavior")
{
  ...
  TTS_EQUAL(s80, (kumi::record {"a"_f = '1', "b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f, "g"_f = 7., "h"_f = '8'}));
...
TTS_CASE("Check record::split constexpr behavior")
{
  ...
  constexpr kumi::record t = {"a"_f = '1', "b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f, "g"_f = 7., "h"_f = '8'};
...

  {
    ...
    TTS_CONSTEXPR_EQUAL(get<1>(s), (kumi::record {"b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f, "g"_f = 7., "h"_f = '8'}));
  }

  {
    constexpr auto s = kumi::split(t,2_c);
    TTS_CONSTEXPR_EQUAL(get<0>(s), (kumi::record {"a"_f = '1', "b"_f = 2.}));
    TTS_CONSTEXPR_EQUAL(get<1>(s), (kumi::record {"c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f, "g"_f = 7., "h"_f = '8'}));
  }
...

  {
    ...
    TTS_CONSTEXPR_EQUAL(get<0>(s), (kumi::record {"a"_f = '1', "b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f}));
    TTS_CONSTEXPR_EQUAL(get<1>(s), (kumi::record {"g"_f = 7., "h"_f = '8'}));
  }

  {
    constexpr auto s = kumi::split(t,7_c);
    TTS_CONSTEXPR_EQUAL(get<0>(s), (kumi::record {"a"_f = '1', "b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f, "g"_f = 7.}));
    TTS_CONSTEXPR_EQUAL(get<1>(s), (kumi::record {"h"_f = '8'}));
  }

  {
    constexpr auto s = kumi::split(t,8_c);
    TTS_CONSTEXPR_EQUAL(get<0>(s), (kumi::record {"a"_f = '1', "b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = 5, "f"_f = 6.f, "g"_f = 7., "h"_f = '8'}));
