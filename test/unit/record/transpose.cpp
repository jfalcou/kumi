...
TTS_CASE("Check result::transpose<record> behavior")
{
  ...
  TTS_TYPE_IS((kumi::result::transpose_t<record_t>),
            (kumi::tuple< kumi::record<char_f , long_double_f >
...
TTS_CASE("Check record::transpose behavior")
{
  ...
  TTS_EQUAL((kumi::transpose(kumi::record{ "n"_f = numbers, "l"_f = letters, "r"_f = ratio })),
            (kumi::tuple{kumi::record {"a"_f = 1, "e"_f = 'a', "i"_f      = 1.f}, 
                         kumi::record {"b"_f = 2, "f"_f = 'b', "j"_f     = 0.1f}, 
