...
TTS_CASE("Check result::reduce_t with prod/sum/bit_* behavior")
{
  ...
  TTS_TYPE_IS ( (kumi::result::reduce_t<kumi::numeric_add, kumi::record<char_f,short_f,int_f,double_f>>)
              , double
              );

  TTS_TYPE_IS ( (kumi::result::reduce_t<kumi::numeric_prod, kumi::record<char_f,short_f,int_f,double_f>>)
              , double
              );

  TTS_TYPE_IS ( (kumi::result::reduce_t<kumi::boolean_or, kumi::record<short_f,size_t_f,int_f>>)
              , std::size_t
              );
    
  TTS_TYPE_IS ( (kumi::result::reduce_t<kumi::boolean_and, kumi::record<short_f,size_t_f,int_f>>)
              , std::size_t
              );
