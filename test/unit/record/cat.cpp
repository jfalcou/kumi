...
TTS_CASE("Check result::cat<record...> behavior")
{
  ...
  TTS_TYPE_IS ( (kumi::result::cat_t<kumi::record<char_rv_f> &&>)
              , (kumi::record<char_rv_f>)
              );
...
TTS_CASE("Check cat(record) behavior")
{
  ...
  TTS_EQUAL((cat(kumi::record {"x"_f = 1, "y"_f = 2.}, kumi::record {"z"_f = 3.f, "t"_f = 4})), 
            (kumi::record {"x"_f = 1, "y"_f = 2., "z"_f = 3.f, "t"_f = 4}));
  TTS_EQUAL((cat(kumi::record {"a"_f = 1, "b"_f = 2.}, kumi::record {"c"_f = 3.f, "d"_f = 4}, kumi::record {"e"_f = s, "f"_f = 6.7})),
  ...
  // Check behavior with record of references
  {
    ...
    TTS_EQUAL(kumi::cat(ref, val), (kumi::record<kumi::field_capture<"a",short&>,kumi::field_capture<"b",float const>>{s,3.14f}) );
  }
  {
    auto ref = kumi::tie<"a"_f>(s);
...
TTS_EQUAL(kumi::cat(ref, std::move(rref), val), (kumi::record<kumi::field_capture<"a",short&>, 
                                                 kumi::field_capture<"b",short &&>, 
...
{ 
  ...
  TTS_CONSTEXPR_EQUAL((cat(kumi::record {"x"_f =1, "y"_f = 2.}, kumi::record {})), (kumi::record {"x"_f = 1, "y"_f = 2.}));
  TTS_CONSTEXPR_EQUAL((cat(kumi::record {}, kumi::record {"x"_f = 1, "y"_f = 2.})), (kumi::record {"x"_f = 1, "y"_f = 2.}));
  ...
  TTS_CONSTEXPR_EQUAL((cat(kumi::record {"x"_f = 1, "y"_f = 2.}, kumi::record {"z"_f = 3.f, "t"_f = 4})), 
            (kumi::record {"x"_f = 1, "y"_f = 2., "z"_f = 3.f, "t"_f = 4}));
  TTS_CONSTEXPR_EQUAL((cat(kumi::record {"a"_f = 1, "b"_f = 2.}, kumi::record {"c"_f = 3.f, "d"_f = 4}, kumi::record {"e"_f = s, "f"_f = 6.7})),
            (kumi::record {"a"_f = 1, "b"_f = 2., "c"_f = 3.f, "d"_f = 4, "e"_f = s, "f"_f = 6.7}));
};