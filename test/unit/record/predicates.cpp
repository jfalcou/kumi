...
TTS_CASE("kumi predicates constexpr behavior on records")
{
  ...
  TTS_CONSTEXPR_EXPECT(kumi::all_of(kumi::make_record("a"_f = 1, "b"_f = 2.5, "c"_f = -3.6f, "d"_f = 4ULL), [](auto e) { return e < 5; }));
  TTS_CONSTEXPR_EXPECT(kumi::any_of(kumi::make_record("a"_f = 1, "b"_f = 2.5, "c"_f = -3.6f, "d"_f = 4ULL), [](auto e) { return e < 0; }));
  TTS_CONSTEXPR_EXPECT(kumi::none_of(kumi::make_record("a"_f = 1, "b"_f = 2.5, "c"_f = -3.6f, "d"_f = 4ULL), [](auto e) { return e > 12; }));
  TTS_CONSTEXPR_EQUAL (kumi::count_if(kumi::make_record("a"_f = 1, "b"_f = 2.5, "c"_f = -3.6f, "d"_f = 4ULL), [](auto e) { return e < 0; }), 1ULL);
  ...
  TTS_CONSTEXPR_EXPECT_NOT(kumi::all_of(kumi::make_record("a"_f = 1, "b"_f = 12.5, "c"_f = 3.6f, "d"_f = 4ULL), [](auto e) { return e < 5; }));
  TTS_CONSTEXPR_EXPECT_NOT(kumi::any_of(kumi::make_record("a"_f = 1, "b"_f = 12.5, "c"_f = 3.6f, "d"_f = 4ULL), [](auto e) { return e < 0; }));
  TTS_CONSTEXPR_EXPECT_NOT(kumi::none_of(kumi::make_record("a"_f = 1, "b"_f = 12.5, "c"_f = 3.6f, "d"_f = 4ULL), [](auto e) { return e > 12; }));

  TTS_CONSTEXPR_EXPECT(kumi::all_of(kumi::make_record("a"_f = 1, "b"_f = 8.5, "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_arithmetic>()));
  TTS_CONSTEXPR_EXPECT(kumi::any_of(kumi::make_record("a"_f = 1, "b"_f = (int*)(nullptr), "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_arithmetic>()));
  TTS_CONSTEXPR_EXPECT(kumi::none_of(kumi::make_record("a"_f = 1, "b"_f = 8.5, "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_pointer>()));
  TTS_CONSTEXPR_EQUAL (kumi::count_if(kumi::make_record("a"_f = 1, "b"_f = 8.5, "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_integral>()), 2ULL);

  TTS_CONSTEXPR_EXPECT_NOT(kumi::all_of(kumi::make_record("a"_f = 1, "b"_f = (int*)(nullptr), "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_arithmetic>()));
  TTS_CONSTEXPR_EXPECT_NOT(kumi::any_of(kumi::make_record("a"_f = 1, "b"_f = (int*)(nullptr), "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_lvalue_reference>()));
  TTS_CONSTEXPR_EXPECT_NOT(kumi::none_of(kumi::make_record("a"_f = 1, "b"_f = 8.5, "c"_f = 3.6f, "d"_f = 4ULL), kumi::predicate<std::is_arithmetic>()));
};