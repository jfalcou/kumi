...
TTS_CASE("Check result::max/max_flat<...> behavior")
{
  ...
  TTS_TYPE_IS(
    (kumi::result::max_flat_t<kumi::record<char_f, kumi::field_capture<"e", kumi::record<short_f, int_f>>, double_f>,
                              func_t>),
    std::size_t);
};
...
TTS_CASE("Check record::max/max_flat behavior")
{
  ...
  auto f0 = kumi::record{"a"_f = 'e', "b"_f = 2., "c"_f = kumi::record{"d"_f = 1., "e"_f = short{55}, "f"_f = 'u'},
                         "g"_f = 3.f, "h"_f = 'z'};
...
TTS_CASE("Check record::max/max_flat constexpr behavior")
{
  ...
  constexpr auto f0 =
    kumi::record{"a"_f = 'e', "b"_f = 2., "c"_f = kumi::record{"d"_f = 1., "e"_f = short{55}, "f"_f = 'u'}, "g"_f = 3.f,
                 "h"_f = 'z'};
