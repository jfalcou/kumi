...
TTS_CASE("kumi locate runtime behavior")
{
  ...
  auto values = kumi::make_record("a"_id = 1, "b"_id = 2.5, "c"_id = -3.6f, "d"_id = 4ULL);
...
TTS_CASE("kumi locate constexpr behavior")
{
  ...
  TTS_CONSTEXPR_EQUAL(kumi::locate(kumi::make_record("a"_id = 1, "b"_id = 2.5, "c"_id = -3.6f, "d"_id = 4ULL),
                                   [](auto e) { return e < 0; }),
                      2ULL);
