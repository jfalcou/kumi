...
TTS_CASE("Check kumi::push_front/pop_front function behavior")
{
  ...
  TTS_EQUAL((kumi::push_front(kumi::record{"a"_f = 3.5, "b"_f = 'e'}, "c"_f = 4)),
            (kumi::record{"c"_f = 4, "a"_f = 3.5, "b"_f = 'e'}));
  ...
  TTS_EQUAL(kumi::pop_front(kumi::record{"a"_f = 4, "b"_f = 3.5, "c"_f = 'e'}),
            (kumi::record{"b"_f = 3.5, "c"_f = 'e'}));
};
...
TTS_CASE("Check kumi::push_front/pop_front constexpr behavior")
{
  ...
  TTS_CONSTEXPR_EQUAL((kumi::push_front(kumi::record{"a"_f = 3.5, "b"_f = 'e'}, "c"_f = 4)),
                      (kumi::record{"c"_f = 4, "a"_f = 3.5, "b"_f = 'e'}));
  ...
  TTS_CONSTEXPR_EQUAL(kumi::pop_front(kumi::record{"a"_f = 4, "b"_f = 3.5, "c"_f = 'e'}),
                      (kumi::record{"b"_f = 3.5, "c"_f = 'e'}));
};
...
TTS_CASE("Check kumi::push_back/pop_back function behavior")
{
  ...
  TTS_EQUAL((kumi::push_back(kumi::record{"a"_f = 3.5, "b"_f = 'e'}, "c"_f = 4)),
            (kumi::record{"a"_f = 3.5, "b"_f = 'e', "c"_f = 4}));
