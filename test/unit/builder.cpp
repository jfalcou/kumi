...
TTS_CASE("Check tuple_element of the output of result::builder_make_t")
{
  ...
  using tpl = kumi::_::builder_make_t<kumi::tuple<double, float, char, int>, char const, double&, float>;
  ...
  using pt = kumi::_::builder_make_t<tuple_box, int&, char const*, double>;
  ...
  using tpt = kumi::_::builder_make_t<trivial_product_type<int, true>, int&, char const*, double>;
  ...
  using rec =
    kumi::_::builder_make_t<kumi::record<>, kumi::field_capture<"a", float const>, kumi::field_capture<"b", int&>>;
  ...
  using rt = kumi::_::builder_make_t<record_box, kumi::field_capture<"a", float const>, kumi::field_capture<"b", int&>>;
  ...
  using trt = kumi::_::builder_make_t<trivial_record_type<int, true>, kumi::field_capture<"a", float const>,
...
TTS_CASE("Check constexpr tuple_element of the output of builder")
{
  ...
  constexpr auto trt =
    kumi::_::builder<trivial_record_type<int, true>>::make("a"_f = 2, "b"_f = 'y', "c"_f = short{77});
