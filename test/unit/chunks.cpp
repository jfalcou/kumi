...
TTS_CASE("Check kumi::result::chunks_t  behavior")
{
  ...
  TTS_TYPE_IS((kumi::result::chunks_t<1, t1>), (kumi::tuple<kumi::tuple<int>, kumi::tuple<const float>, kumi::tuple<char&>, kumi::tuple<volatile short>>));
...
TTS_CASE("Check runtime kumi::chunks behavior")
{
  ...
  TTS_EQUAL ( (kumi::chunks<2>(t2)), (kumi::make_tuple(kumi::tuple{112, -18.f}, kumi::make_tuple(kumi::tuple{'1', long{22}, kumi::str{"Yes"}})) ) );

  TTS_EQUAL((kumi::chunks<2>(std::move(t2))), (kumi::make_tuple(kumi::tuple{112, -18.f}, kumi::make_tuple(kumi::tuple{'1', long{22}, kumi::str{"Yes"}})) ) );
};
...
TTS_CASE("Check constexpr kumi::chunks behavior")
{
  ...
  TTS_CONSTEXPR_EQUAL ( (kumi::chunks<2>(t2)), (kumi::make_tuple(kumi::tuple{112, -18.f}, kumi::make_tuple(kumi::tuple{'1', long{22}, kumi::str{"Yes"}})) ) );
