...
/*TTS_CASE("Check kumi::tuple behavior with fields")
{
  ...
  auto t = kumi::tuple{"a"_id = x, "b"_id = y, "c"_id = kumi::test::ref(x), "d"_id = kumi::test::cref(y), "e"_id = z};
  ...
  auto pt = kumi::tuple{"a"_id = x, y, kumi::test::ref(x), "d"_id = kumi::test::cref(y), z};
