...
TTS_CASE("Check result::min/min_flat<...> behavior")
{
  ...
  TTS_TYPE_IS((kumi::result::min_t<kumi::tuple<char, short, int, double>, func_t>), std::size_t);

  TTS_TYPE_IS((kumi::result::min_flat_t<kumi::tuple<char, short, int, double>, func_t>), std::size_t);

  TTS_TYPE_IS((kumi::result::min_flat_t<kumi::tuple<char, kumi::tuple<short, int>, double>, func_t>), std::size_t);
};
