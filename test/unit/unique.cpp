...
TTS_CASE("Check result::unique/all_unique<T> behavior")
{
  ...
  TTS_TYPE_IS((kumi::result::unique_t<kumi::tuple<kumi::tuple<int, char>, kumi::tuple<int, char>, char, int>>),
              (kumi::tuple<kumi::tuple<int, char>, char, int>));

  TTS_TYPE_IS((kumi::result::unique_t<kumi::tuple<int&, int, int const, int const*, int&&>>),
              (kumi::tuple<int&, int, int const, int const*, int&&>));

  TTS_TYPE_IS((kumi::result::all_unique_t<kumi::tuple<char, int, int, char, double>>),
              (kumi::tuple<char, int, double>));

  TTS_TYPE_IS((kumi::result::all_unique_t<kumi::tuple<kumi::tuple<int, char>, kumi::tuple<int, char>, char, int>>),
              (kumi::tuple<kumi::tuple<int, char>, char, int>));

  TTS_TYPE_IS((kumi::result::all_unique_t<kumi::tuple<int&, int, int const, int const*, int&&>>),
              (kumi::tuple<int&, int, int const, int const*, int&&>));
};
