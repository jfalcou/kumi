...
TTS_CASE("kumi predicates constexpr behavior on tuples")
{
  ...
  TTS_CONSTEXPR_EXPECT(
    kumi::any_of(kumi::make_tuple(1, (int*)(nullptr), 3.6f, 4ULL), kumi::predicate<std::is_arithmetic>()));
  ...
  TTS_CONSTEXPR_EXPECT_NOT(
    kumi::all_of(kumi::make_tuple(1, (int*)(nullptr), 3.6f, 4ULL), kumi::predicate<std::is_arithmetic>()));
  TTS_CONSTEXPR_EXPECT_NOT(
    kumi::any_of(kumi::make_tuple(1, (int*)(nullptr), 3.6f, 4ULL), kumi::predicate<std::is_lvalue_reference>()));
