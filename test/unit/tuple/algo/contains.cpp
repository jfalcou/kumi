...
TTS_CASE("Check kumi::result::contains_t behavior")
{
  ...
  kumi::tuple values{custom_ = foo{}, "surname"_id = tts::text("john"), value_ = 3.f,
...
TTS_CASE("Check kumi::result::contains_any behavior")
{
  ...
  kumi::tuple values{custom_ = foo{}, "surname"_id = tts::text("john"), value_ = 3.f, "aligned"_id, is_transparent_};
...
TTS_CASE("Check kumi::result::contains_none behavior")
{
  ...
  kumi::tuple values{custom_ = foo{}, "surname"_id = tts::text("john"), value_ = 3.f, "aligned"_id,
                     "is_transparent_"_id};
