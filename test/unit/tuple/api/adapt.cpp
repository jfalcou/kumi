...
TTS_CASE("Check adapted types model kumi::concepts::product_type concept")
{
  ...
  TTS_EXPECT((kumi::concepts::product_type<std::array<int, 4>>));
  TTS_EXPECT((kumi::concepts::product_type<std::pair<int, float>>));
  TTS_EXPECT((kumi::concepts::product_type<std::tuple<int, char, float>>));
};
...
TTS_CASE("Check adapted type behave like a product_type")
{
  ...
  TTS_EQUAL(zz, (kumi::tuple{kumi::tuple{1, 99}, kumi::tuple{2.5, 69.25}, kumi::tuple{'4', 'Z'}}));
...
TTS_CASE("Check adapted external type behave like a product_type")
{
  ...
  TTS_EQUAL(zz, (kumi::tuple{kumi::tuple{1, 0.1}, kumi::tuple{2, 2.3}, kumi::tuple{5, 4.5}}));
