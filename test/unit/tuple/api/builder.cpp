...
TTS_CASE("Check tuple_element of the output of builder")
{
  ...
  auto rec = kumi::builder<kumi::record<>>::make("a"_n = 2, "b"_n = 'y', "c"_n = short{77});
  ...
  auto rt = kumi::builder<record_box>::make("a"_n = 2, "b"_n = 'y', "c"_n = short{77});
  ...
  auto trt = kumi::builder<trivial_record_type<int, true>>::make("a"_n = 2, "b"_n = 'y', "c"_n = short{77});
...
TTS_CASE("Check constexpr tuple_element of the output of builder")
{
  ...
  constexpr auto rec = kumi::builder<kumi::record<>>::make("a"_n = 2, "b"_n = 'y', "c"_n = short{77});
  TTS_TYPE_IS((decltype(rec)), (kumi::record<kumi::field<kumi::name<"a">, int>, kumi::field<kumi::name<"b">, char>,
  ...
  constexpr auto rt = kumi::builder<record_box>::make("a"_n = 2, "b"_n = 'y', "c"_n = short{77});
  TTS_TYPE_IS((decltype(rt)), (kumi::record<kumi::field<kumi::name<"a">, int>, kumi::field<kumi::name<"b">, char>,
                                            kumi::field<kumi::name<"c">, short>> const));
  ...
  constexpr auto trt = kumi::builder<trivial_record_type<int, true>>::make("a"_n = 2, "b"_n = 'y', "c"_n = short{77});
  TTS_TYPE_IS((decltype(trt)), (kumi::record<kumi::field<kumi::name<"a">, int>, kumi::field<kumi::name<"b">, char>,
                                             kumi::field<kumi::name<"c">, short>> const));
