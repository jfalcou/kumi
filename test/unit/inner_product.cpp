...
TTS_CASE("Check result::inner_product_t behavior")
{
  ...
  TTS_TYPE_IS ( (kumi::result::inner_product_t< kumi::tuple<int,double>
                                              , kumi::tuple<char,short>
                                              , int
                                              >
                )
              , double
...
TTS_CASE("Check tuple::inner_product behavior")
{
  ...
  TTS_EQUAL ( kumi::inner_product ( t1, t2, 1ULL
...
TTS_CASE("Check tuple::inner_product constexpr behavior")
{
  ...
  TTS_CONSTEXPR_EQUAL ( kumi::inner_product ( kumi::tuple{2,4,8}
                                            , kumi::tuple{2.5,4.5,7.5}, 1ULL
                                            , [](auto a, auto b) { return a*b; }
                                            , [](auto a, auto b) { return a+b; }
                                            )
                      , 592.875
