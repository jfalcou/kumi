...
TTS_CASE("Check is_homogeneous for kumi::tuple")
{
  ...
  TTS_CONSTEXPR_EXPECT_NOT((kumi::homogeneous_product_type<kumi::record<
              kumi::field_capture<"a",int>, kumi::field_capture<"b", int>, kumi::field_capture<"c", int>>>));

  TTS_CONSTEXPR_EXPECT_NOT((kumi::homogeneous_product_type<kumi::record<
              kumi::field_capture<"a",int>, kumi::field_capture<"b", float>, kumi::field_capture<"c", char>>>));
};
