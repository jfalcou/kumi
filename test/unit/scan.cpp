...
struct sizeof_monoid
{
    template<typename T1, typename T2>
    constexpr auto operator()([[maybe_unused]]T1 && a, [[maybe_unused]]T2 && b)
    {
...
TTS_CASE("Check result::inclusive_scan_right/inclusive_scan_left<...> behavior")
{
  ...
  TTS_TYPE_IS((kumi::result::inclusive_scan_right_t<right_func_t,kumi::tuple<char,short,int,double>,int>), res_tuple);
  TTS_TYPE_IS((kumi::result::inclusive_scan_left_t<left_func_t  ,kumi::tuple<char,short,int,double>,int>), res_tuple);
...
TTS_CASE("Check kumi::inclusive_scan_right behavior")
{
  ...
  auto sizeof_init = kumi::inclusive_scan_right(
      [](auto m, auto) {
        return sizeof(m);
      },
      t,
...
{  
  ...
  constexpr auto accumulated = kumi::inclusive_scan_right(
      [](auto m, auto) {
        return sizeof(m);       
      },
      t,
...
TTS_CASE("Check kumi::exclusive_scan_right behavior")
{
  ...
  auto sizeof_init = kumi::exclusive_scan_right(
      [](auto m, auto) {
        return sizeof(m);
      },
      t,
  ...
  auto accumulated_init = kumi::exclusive_scan_right(
      [](auto m, auto acc) {
        return acc + sizeof(m);
      },
      t,
...
{  
  ...
  constexpr auto accumulated = kumi::exclusive_scan_right(
      [](auto m, auto) {
        return sizeof(m);       
      },
      t,
...
TTS_CASE("Check kumi::inclusive_scan_left behavior")
{
  ...
  auto sizeof_init = kumi::inclusive_scan_left(
      [](auto, auto m) {
        return sizeof(m);
      },
      t,
  ...
  auto accumulated_init = kumi::inclusive_scan_left(
      [](auto acc, auto m) {
        return acc + sizeof(m);
      },
      t,
...
{  
  ...
  constexpr auto accumulated = kumi::inclusive_scan_left(
      [](auto, auto m) {
        return sizeof(m);       
      },
      t,
...
TTS_CASE("Check kumi::exclusive_scan_left behavior")
{
  ...
  auto sizeof_init = kumi::exclusive_scan_left(
      [](auto, auto m) {
        return sizeof(m);
      },
      t,
  ...
  auto accumulated_init = kumi::exclusive_scan_left(
      [](auto acc, auto m) {
        return acc + sizeof(m);
      },
      t,
...
{  
  ...
  constexpr auto accumulated = kumi::exclusive_scan_left(
      [](auto, auto m) {
        return sizeof(m);       
      },
      t,
