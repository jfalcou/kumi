...
TTS_CASE("Check result::partition<Func,Tuple> behavior")
{
  ...
  TTS_TYPE_IS((kumi::result::partition_t<std::is_rvalue_reference, kumi::tuple<int&, float&&, double const&>>),
              (kumi::tuple<kumi::tuple<float&&>, kumi::tuple<int&, double const&>>));
};

TTS_CASE("Check partition(kumi::tuple<>{}) behavior")
{
  TTS_EQUAL((kumi::partition<std::is_pointer>(kumi::tuple{})), (kumi::tuple<kumi::tuple<>, kumi::tuple<>>{}));
};
...
TTS_CASE("Check partition() behavior with values")
{
  ...
  TTS_EQUAL(kumi::partition<std::is_null_pointer>(original), (kumi::tuple{kumi::tuple{nullptr}, kumi::tuple{
                                                                                                  a,
                                                                                                  &a,
                                                                                                  b,
                                                                                                  &b,
  ...
  TTS_EQUAL(kumi::partition<std::is_null_pointer>(std::move(original)), (kumi::tuple{kumi::tuple{nullptr}, kumi::tuple{
                                                                                                             a,
                                                                                                             &a,
                                                                                                             b,
                                                                                                             &b,
