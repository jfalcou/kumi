...
namespace kumi
{
  ...
  //================================================================================================
  template<product_type T>
  [[nodiscard]] KUMI_ABI constexpr bool none_of(T && t) noexcept
  {
  ...
  [[nodiscard]] KUMI_ABI constexpr std::size_t count_if( T && t, Pred p) noexcept
  {
    ...
    else return  kumi::apply( [&](auto &&... m) { return ( (p(m)? o : z) + ... + z); }, KUMI_FWD(t) );
  }
  ...
  //================================================================================================
  template<product_type T>
  [[nodiscard]] KUMI_ABI constexpr std::size_t count( T && t ) noexcept
  {
